...
export default async function BuhForecastPage({
  searchParams,
}: {
  ...
  return (
    <div className="space-y-4">
      ...
      <LazyForecastSheet
        ...
        title={`Submitted forecast (${selectedMonthLabel})`}
        subtitle="Read-only forecast view for the business-unit scope assigned by admin."
      />
    </div>
  );
}
